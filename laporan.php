<?php
      ...
      if(isset($_REQUEST['submit'])){
         ...
         $tgl1 = $_REQUEST['tgl1'];
         $tgl2 = $_REQUEST['tgl2'];
         $sql=mysqli_query($con,"SELECT orders WHERE orderDate BETWEEN '$tgl1' AND '$tgl2'");
	 ...
	 echo '
		...
		<div class="col-sm-6"><table class="table table-bordered">';
		 ...
		 $sql = mysqli_query($con, "SELECT count(productId), sum(quantity) FROM orders WHERE orderDate BETWEEN '$tgl1' AND '$tgl2'");
