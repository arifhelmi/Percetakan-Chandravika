...
<html lang="en">
	<head>
	    ...
	    <title>PERCETAKAN CV.CHANDRAVIKA| Home Page</title>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">kualitas terbaik</h4>
						</div>
					</div>	
					<h6 class="text">Jaminan kualitas terbaik dan proses pengerjaan cepat</h6>
				</div>
			</div><!-- .col -->
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<?php
							$filename = 'jumlah_pengunjung.txt';
							function lihat(){
								global $filename;
								...
								lihat();
								// echo 'total pengunjung adalah'.file_get_contents($filename);
								?>
							<h4 class="info-box-heading green">Total Pengunjung</h4>
						</div>
					</div>	
					<h6 class="text">
        <?php
	...
	<div class="info-boxes-inner">
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Produk Unggulan</h3>
				...
				<div class="row">
					<div class="col-md-12">
	                   <section class="section">
	                   	<h3 class="section-title">Stationary</h3>
...
<?php }?>
					...
					<div class="col-md-12">
						<section class="section">
							<h3 class="section-title">Kemasan</h3>
