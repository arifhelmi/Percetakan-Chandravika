...
<div class="control-group">
<label class="control-label" for="basicinput">Berat Product</label>
<div class="controls">
<input type="text"    name="productberat_product"  placeholder="Masukkan harga ongkos kirim" value="<?php echo htmlentities($row['berat_product']);?>" class="span8 tip" required>
</div>
</div>
