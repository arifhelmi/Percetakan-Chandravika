...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		echo "<script type='text/javascript'> document.location ='my-cart.php'; </script>";
			...
			$message="Id produk tidak sesuai";
		}
	}
}
$pid=intval($_GET['pid']);
...
echo "<script>alert('Produk ditambahkan ke favorit');</script>";
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Rp <?php echo htmlentities($rws['productPrice']);?>
								</span>
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								...
								<?php if($row['productAvailability']=='Tersedia'){?>
										<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
								<i class="fa fa-shopping-cart"></i>													
							</button> <a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
							<button class="btn btn-primary" type="button">Tambah ke keranjang</button></a>
								<?php } else {?>
							<div class="action" style="color:red">Lihat</div>
					<?php } ?>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Bahan Produk :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Berat Product :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php if($row['berat_product']==0)
											{
												echo "Free";
											}
											else
											{
												echo htmlentities($row['berat_product']);
											}
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
					<?php if($row['productAvailability']=='Tersedia'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Tambah ke keranjang</a>
													<?php } 
							else {?>
							<div class="action" style="color:red">Habis</div>
					<?php } ?>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">DEKRIPSI</a></li>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Kualitas :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													<div class="text"><b>Harga :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Nama <span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Komentar <span class="astk">*</span></label>
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Produk yang sama </h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Tambah ke keranjang</a>
