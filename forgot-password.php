...
$_SESSION['errmsg']="Password Berhasil Diubah";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Email atau No Hp Tidak Sesuai";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>PERCETAKAN CV.GLORIA USU | Lupa password</title>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">No Hp <span>*</span></label>
