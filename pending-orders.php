...
<html lang="en">
	<head>
	    ...
	    <title>Riwayat Pesanan Belum Selesai</title>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">Total harga</th>
					<th class="cart-total item">Metode pembayaran</th>
					<th class="cart-description item">Tanggal pesanan</th>
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Hapus</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Data Tidak Ditemukan</h4></td>
</tr>
<?php } ?>
