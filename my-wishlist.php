...
// Code untuk menghapus produk dari favorit	
$wid=intval($_GET['del']);
if(isset($_GET['del']))
{
...
?>
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Tambah ke keranjang</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Favorit masih belum ditambahkan</td>
